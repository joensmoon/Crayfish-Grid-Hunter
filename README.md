# Crayfish Grid Hunter (小龙虾网格猎人) v2.2.2
...
v2.2.2 修复了一个严重问题：AI Agent 在读取 SKILL.md 后不调用脚本而是自行生成数据。本次更新彻底解决了这个问题：
...
├── TEST_RESULTS.md         # 最新版本测试报告 (v2.2.2)
├── install.sh              # 一键安装脚本
├── docs/                   # 完整文档体系
│   ├── QUICK_START.md
│   ├── EXAMPLES.md
...
核心算法引擎、回测系统及所有 v2.2.2 新增模块均经过严格的本地单元测试。
